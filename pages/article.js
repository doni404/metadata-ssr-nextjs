        ...
        <div className={styles.container}>
            ...
            <main className={styles.main}>
                <h1 className={styles.title}>
                    Welcome to <a href="https://nextjs.org">ARTICLE PAGE!</a>
                </h1>
...
export const getServerSideProps = async () => {
    ...
    const meta = {
        "title": "記事一覧 | Art With Me",
        "url": "https://dev.art-with.me/article",
        "card": "summary_large_image",
        "description": "Art With Meからのお知らせ、イベント等のご案内です。Art With Meからのお知らせ、イベント等のご案内です。",
        "keywords": "Art With Me,福祉NFT,記事",
        "image": "https://dev-api.art-with.me/v1/public/resources?type=article_series&filename=2022-12-05_18:20:21.jpeg",
        "type": "website"
    }
